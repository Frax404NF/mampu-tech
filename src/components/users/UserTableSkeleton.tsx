  ...
  return (
    <div role="status" aria-label="Loading users" className="animate-pulse">
      ...
      <div className="hidden sm:block overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
        {/* Header row skeleton — 4 columns: Name(3) Email(3) Website(3) Todos(3) */}
        ...
        <div className="divide-y divide-gray-100">
          {Array.from({ length: SKELETON_ROW_COUNT }).map((_, index) => (
            ...
            >
              <div className="col-span-3 h-4 bg-gray-200 rounded w-3/4" />
              <div className="col-span-3 h-4 bg-gray-200 rounded w-2/3" />
              <div className="col-span-3 h-4 bg-gray-200 rounded w-full" />
              {/* Todos progress shimmer */}
